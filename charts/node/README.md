...
| node.chainData.emptyDir | object | `{"enabled":false}` | Mount chain-data volume using an emptyDir volume |
...
| node.collatorRelayChain.chainData.emptyDir | object | `{"enabled":false}` | Mount relaychain-data volume using an emptyDir volume |

...
| `node.perNodeServices.createClusterIPService`                             | If true creates a clusterIP API service (deprecated, replaced by `createApiService`)                                                                                                                                                                  | `true`                                                              |
| `node.perNodeServices.createApiService`                                   | If true creates a headless ClusterIP API service for every node in the statefulset                                                                                                                                                                    | `true`                                                              |
| `node.perNodeServices.createP2pService`                                   | If true creates a p2p services for every node in the statefulset; if `node.collator.isParachain` also true, creates a NodePort p2p service for the parachain                                                                                          | `true`                                                              |
| `node.perNodeServices.createP2pNodePortService`                           | If true creates a p2p NodePort service, if `node.collator.isParachain` also true, creates a NodePort p2p service for the parachain (deprecated, replaced by `createP2pService`)                                                                       | `false`                                                             |
| `node.perNodeServices.p2pServiceType `                                    | Define the type of the created p2p services (`ClusterIP`, `NodePort` or `LoadBalancer`)                                                                                                                                                               | `NodePort`                                                          |
...
| `node.perNodeServices.apiServiceAnnotations`                              | Annotations to be inserted into the API service                                                                                                                                                                                                       | `{}`                                                                |

...
| `node.perNodeServices.relayP2pService.ws.port`                            | Port to use to expose the relay-chain WebSocket P2P Service externally                                                                                                                          | `30444`                                                              |
...
| `node.perNodeServices.paraP2pService.ws.port`                             | Port to use to expose the para-chain WebSocket P2P Service externally                                                                                                                          | `29444`                                                              |
